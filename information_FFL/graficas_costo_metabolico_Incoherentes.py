...
plt.scatter(posiciones,estado_estacionario_Y_I1[0:,1], label = "FFL I1")
plt.scatter(posiciones,estado_estacionario_Y_I2[0:,1], label = "FFL I2")
plt.scatter(posiciones,estado_estacionario_Y_I3[0:,1], label = "FFL I3")
plt.scatter(posiciones,estado_estacionario_Y_I4[0:,1], label = "FFL I4")
plt.legend()
...
plt.scatter(posiciones,estado_estacionario_Z_I1[0:,1], label = "FFL I1")
plt.scatter(posiciones,estado_estacionario_Z_I2[0:,1], label = "FFL I2")
plt.scatter(posiciones,estado_estacionario_Z_I3[0:,1], label = "FFL I3")
plt.scatter(posiciones,estado_estacionario_Z_I4[0:,1], label = "FFL I4")
plt.legend()
