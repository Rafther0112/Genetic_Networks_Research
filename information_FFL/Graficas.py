...
figuras[0,0].scatter(np.arange(1,10), simulacion_FFL_C1["InformacionYX"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[0,1].scatter(np.arange(1,10), simulacion_FFL_C1["InformacionZX"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[1,0].scatter(np.arange(1,10), simulacion_FFL_C1["InformacionZY"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[1,1].scatter(np.arange(1,10), simulacion_FFL_C1["InformacionZXY"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[0,0].scatter(np.arange(1,10), simulacion_FFL_C2["InformacionYX"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[0,1].scatter(np.arange(1,10), simulacion_FFL_C2["InformacionZX"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[1,0].scatter(np.arange(1,10), simulacion_FFL_C2["InformacionZY"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[1,1].scatter(np.arange(1,10), simulacion_FFL_C2["InformacionZXY"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[0,0].scatter(np.arange(1,9), simulacion_FFL_C3["InformacionYX"], color = "red", label ="Simulacion Computacional", marker = "*")
figuras[0,0].set_xlabel("Tasa de sintesis Kx")
figuras[0,0].set_ylabel("Información mutua")
figuras[0,0].legend()
...
figuras[0,1].scatter(np.arange(1,9), simulacion_FFL_C3["InformacionZX"], color = "red", label ="Simulacion Computacional", marker = "*")
figuras[0,1].set_xlabel("Tasa de sintesis Kx")
figuras[0,1].set_ylabel("Información mutua")
figuras[0,1].legend()
...
figuras[1,0].scatter(np.arange(1,9), simulacion_FFL_C3["InformacionZY"], color = "red", label ="Simulacion Computacional", marker = "*")
figuras[1,0].set_xlabel("Tasa de sintesis Kx")
figuras[1,0].set_ylabel("Información mutua")
figuras[1,0].legend()
...
figuras[1,1].scatter(np.arange(1,9), simulacion_FFL_C3["InformacionZXY"], color = "red", label ="Simulacion Computacional", marker = "*")
figuras[1,1].set_xlabel("Tasa de sintesis Kx")
figuras[1,1].set_ylabel("Información mutua")
figuras[1,1].legend()
...
figuras[0,0].scatter(np.arange(1,10), simulacion_FFL_C1["InformacionZXY"], color = "red", label ="Simulacion Computacional", marker = "*")
figuras[0,0].set_xlabel("Tasa de sintesis Kx")
figuras[0,0].set_ylabel("Información mutua")
figuras[0,0].legend()
...
figuras[0,1].scatter(np.arange(1,10), simulacion_FFL_C4["InformacionZXY"], color = "red", label ="Simulacion Computacional", marker = "*")
figuras[0,1].set_xlabel("Tasa de sintesis Kx")
figuras[0,1].set_ylabel("Información mutua")
figuras[0,1].legend()
...
figuras[1,0].scatter(np.arange(1,10), simulacion_FFL_C2["InformacionZXY"], color = "red", label ="Simulacion Computacional", marker = "*")
figuras[1,0].set_xlabel("Tasa de sintesis Kx")
figuras[1,0].set_ylabel("Información mutua")
figuras[1,0].legend()
...
figuras[2,0].scatter(np.arange(1,10), simulacion_FFL_I1["InformacionZXY"], color = "red", label ="Simulacion Computacional", marker = "*")
...
figuras[2,1].scatter(np.arange(1,9), simulacion_FFL_I2["InformacionZXY"], color = "red", label ="Simulacion Computacional", marker = "*")
